...
public class BlockMaxWandTest extends MatchingSetupTest
{
	...
	{
		return Arrays.asList(new Object[][] { {query2, "BM25"} });
	}
	*/
	...
	@Before public void createBlockMaxScoreIndexes() throws IOException, InterruptedException
	{
/*
		String argsBMS[] = new String[4];
		
		argsBMS[0] = terrierEtc;
		argsBMS[1] = "data" + EliasFano.USUAL_EXTENSION;
		if (model.equals("BM25Fast"))
			argsBMS[2] = "BM25";
		else
			argsBMS[2] = model;
		argsBMS[3] = "4";
		
		PostingBlockGenerator.main(argsBMS);
*/
	}
